...
> 到2021年3月16日 09:41:13为止

channel | 通道说明 | 测试通过
---|---|---
ALI_CHANNEL_APP | 支付宝App | Yes
ALI_CHANNEL_WAP | 支付宝H5 | Yes
WX_CHANNEL_APP | 微信App,需要在微信开放平台申请应用&开通支付,在商户完成绑定 | Yes
WX_CHANNEL_WAP | 微信H5 | Yes
ALI_CHANNEL_WEB | 支付宝PC-web | Not Test
ALI_CHANNEL_BAR | 支付宝条形码 | Not Test
ALI_CHANNEL_QR | 支付宝扫码 | Not Test
WX_CHANNEL_LITE | 微信小程序 | Not Test
WX_CHANNEL_QR | 微信PC-二维码 | Not Test
WX_CHANNEL_PUB | 微信公众号-网页 | Not Test
WX_CHANNEL_BAR | 微信条形码 | Not Test


#### APP支付请求参数

> 对应channel： \myttyy\Hyperf\Payment\Client::ALI_CHANNEL_APP
...
> 对应channel： \myttyy\Hyperf\Payment\Client::ALI_CHANNEL_BAR
...
> 对应channel： \myttyy\Hyperf\Payment\Client::ALI_CHANNEL_WEB
